...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // PWA Install Prompt - Hidden (no UI elements)
    // Service worker and manifest still work for PWA functionality
    // Users can install via browser's native install option
    window.addEventListener('beforeinstallprompt', (e) => {
        // Prevent the mini-infobar from appearing
        e.preventDefault();
        console.log('[PWA] Install prompt available (hidden from UI)');
    });
});
